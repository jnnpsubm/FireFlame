...
public:
    ...
    void CopyData(int elementIndex, size_t size, const void* data)
    {
...
{
public:
    UploadBuffer2(ID3D12Device* device, UINT elementCount, bool isConstantBuffer) :
    ...
    UploadBuffer2(const UploadBuffer2& rhs) = delete;
    UploadBuffer2& operator=(const UploadBuffer2& rhs) = delete;
    ~UploadBuffer2()
    {
        if (mUploadBuffer != nullptr)
            mUploadBuffer->Unmap(0, nullptr);
