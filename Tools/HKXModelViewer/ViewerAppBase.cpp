...
ViewerAppBase::ViewerAppBase(FireFlame::Engine& engine, float cameraMinDis, float cameraMaxDis) :
    mEngine(engine),
...
void ViewerAppBase::OnGameWindowResized(int w, int h) {
...
void ViewerAppBase::Update(float time_elapsed) {
...
void ViewerAppBase::OnMouseDown(WPARAM btnState, int x, int y) {
    mLastMousePos.x = x;
    mLastMousePos.y = y;
    SetCapture(mEngine.GetWindow()->MainWnd());
}
void ViewerAppBase::OnMouseUp(WPARAM btnState, int x, int y) {
    ReleaseCapture();
}
void ViewerAppBase::OnMouseMove(WPARAM btnState, int x, int y) {
...
void ViewerAppBase::OnKeyUp(WPARAM wParam, LPARAM lParam) {
    if (wParam == 'W') {
...
void ViewerAppBase::OnKeyboardInput(float time_elapsed)
{
