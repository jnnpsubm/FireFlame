...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PSTR cmdLine, int showCmd) {
	...
	try {
        ...
        shader.AddShaderStage(L"Shaders\\Noise2.hlsl", Shader_Type::VS, "VS", "vs_5_0");
        shader.AddShaderStage(L"Shaders\\Noise2.hlsl", Shader_Type::PS, "PS", "ps_5_0");
