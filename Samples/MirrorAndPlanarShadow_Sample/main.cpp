...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PSTR cmdLine, int showCmd) {
    ...
    try {
        ...
        // application handles
        engine.RegisterUpdateFunc(std::bind(&FLEngineApp2::Update, &app, std::placeholders::_1));
        engine.RegisterWindowResizedHandler(std::bind(&FLEngineApp2::OnGameWindowResized, &app, _1, _2));
        engine.GetWindow()->RegisterMouseHandlers
        (
            std::bind(&FLEngineApp2::OnMouseDown, &app, _1, _2, _3),
            std::bind(&FLEngineApp2::OnMouseUp, &app, _1, _2, _3),
            std::bind(&FLEngineApp2::OnMouseMove, &app, _1, _2, _3)
        );
        engine.GetWindow()->RegisterKeyUpHandler(std::bind(&FLEngineApp2::OnKeyUp, &app, _1, _2));
