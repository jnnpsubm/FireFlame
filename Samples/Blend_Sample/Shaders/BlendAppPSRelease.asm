...
dp3 r1.w, -cb2[29].xyzx, r1.xyzx
max r1.w, r1.w, l(0.000000)
mul r4.xyz, r1.wwww, cb2[28].xyzx
mul r1.w, r3.x, l(256.000000)
add r5.xyz, r2.xyzx, -cb2[29].xyzx
dp3 r2.w, r5.xyzx, r5.xyzx
rsq r2.w, r2.w
mul r5.xyz, r2.wwww, r5.xyzx
mad r2.w, r3.x, l(256.000000), l(8.000000)
...
dp3_sat r4.w, r5.xyzx, -cb2[29].xyzx
add r4.w, -r4.w, l(1.000000)
mul r5.x, r4.w, r4.w
mul r5.x, r5.x, r5.x
mul r4.w, r4.w, r5.x
mad r5.xyz, r3.yzwy, r4.wwww, cb1[1].xyzx
mul r6.xyz, r3.xxxx, r5.xyzx
mad r5.xyz, r5.xyzx, r3.xxxx, l(1.000000, 1.000000, 1.000000, 0.000000)
div r5.xyz, r6.xyzx, r5.xyzx
add r5.xyz, r0.xyzx, r5.xyzx
dp3 r3.x, -cb2[32].xyzx, r1.xyzx
max r3.x, r3.x, l(0.000000)
mul r6.xyz, r3.xxxx, cb2[31].xyzx
add r7.xyz, r2.xyzx, -cb2[32].xyzx
dp3 r3.x, r7.xyzx, r7.xyzx
rsq r3.x, r3.x
mul r7.xyz, r3.xxxx, r7.xyzx
dp3 r3.x, r7.xyzx, r1.xyzx
max r3.x, r3.x, l(0.000000)
log r3.x, r3.x
mul r3.x, r1.w, r3.x
exp r3.x, r3.x
mul r3.x, r2.w, r3.x
mul r3.x, r3.x, l(0.125000)
dp3_sat r4.w, r7.xyzx, -cb2[32].xyzx
add r4.w, -r4.w, l(1.000000)
mul r5.w, r4.w, r4.w
mul r5.w, r5.w, r5.w
mul r4.w, r4.w, r5.w
mad r7.xyz, r3.yzwy, r4.wwww, cb1[1].xyzx
mul r8.xyz, r3.xxxx, r7.xyzx
mad r7.xyz, r7.xyzx, r3.xxxx, l(1.000000, 1.000000, 1.000000, 0.000000)
div r7.xyz, r8.xyzx, r7.xyzx
add r7.xyz, r0.xyzx, r7.xyzx
mul r6.xyz, r6.xyzx, r7.xyzx
mad r4.xyz, r5.xyzx, r4.xyzx, r6.xyzx
dp3 r3.x, -cb2[35].xyzx, r1.xyzx
max r3.x, r3.x, l(0.000000)
mul r5.xyz, r3.xxxx, cb2[34].xyzx
...
dp3_sat r1.y, r2.xyzx, -cb2[35].xyzx
add r1.y, -r1.y, l(1.000000)
mul r1.z, r1.y, r1.y
mul r1.z, r1.z, r1.z
mul r1.y, r1.y, r1.z
mad r1.yzw, r3.yyzw, r1.yyyy, cb1[1].xxyz
...
mad r0.xyz, cb2[27].xyzx, r0.xyzx, r1.xyzx
mov o0.xyzw, r0.xyzw
ret 
