...
void TexWavesApp::AddShaders()
{
    using namespace FireFlame;
    mShaderDesc.name = "TexWaves";
...
FireFlame::Vector3f TexWavesApp::GetHillsNormal(float x, float z) const
{
    // n = (-df/dx, 1, -df/dz)
...
void TexWavesApp::AddRenderItems()
{
...
void TexWavesApp::OnKeyUp(WPARAM wParam, LPARAM lParam)
{
    if ((int)wParam == 'R')
    {
        mEngine.Resume();
