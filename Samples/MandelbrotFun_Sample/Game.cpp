...
void Game::OnKeyUp(WPARAM wParam, LPARAM lParam) {
    ...
    {
        mShaderConstants.uS0 *= 2.f;
        mShaderConstants.uT0 *= 2.f;
    }
    else if (wParam == 'K')
    {
        mShaderConstants.uS0 /= 2.f;
